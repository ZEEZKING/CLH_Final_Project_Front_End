...
//     await fetch('https://localhost:7285/api/Room/GetAllAvailableRooms')
//     .then(data => data.json())
...
//                                 </div>  
//                                 <div class="d-flex mb-3">
//                                     <small class="me-3 pe-3">Description : ${room.description}</small>
//                                 </div>
...
async function fetchData() {
    try {
        const response = await fetch('https://localhost:7285/api/Room/GetAllAvailableRooms');       ///https://localhost:7285/api/Room/GetAllUnAvailableRooms
